...
#
# Created: Wed May 11 12:15:41 2016
...
class Ui_DetailsResource(object):
    def setupUi(self, DetailsResource):
        ...
        self.verticalLayout_3.addWidget(self.status_button)
    ...
    def retranslateUi(self, DetailsResource):
        ...
        self.status_button.setToolTip(_translate("DetailsResource", "Quelldatei erneut prüfen", None))
