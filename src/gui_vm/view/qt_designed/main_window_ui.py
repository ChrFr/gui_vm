...
#
# Created: Tue Nov 25 16:49:40 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/buttons/icons/reload.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.reload_button.setIcon(icon5)
        self.reload_button.setIconSize(QtCore.QSize(21, 21))
        self.reload_button.setObjectName(_fromUtf8("reload_button"))
        self.gridLayout_4.addWidget(self.context_button_group, 0, 2, 1, 1)
