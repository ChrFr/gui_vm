...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.context_button_group.setMinimumSize(QtCore.QSize(155, 35))
        ...
        self.gridLayout_4.addWidget(self.context_button_group, 0, 5, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/buttons/icons/open.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
